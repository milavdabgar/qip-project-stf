...
{\normalsize AICTE QIP PG Certification Programme on}\\[0.1cm]
{\normalsize \textbf{"Deep Learning: Fundamentals and Applications"}}
...
\column{0.3\textwidth}
\centering
\includegraphics[width=0.55\textwidth]{AICTE.jpeg}
...
\column{0.3\textwidth}
\centering
\includegraphics[width=0.55\textwidth]{svnit_logo.jpg}
\end{columns}

\vspace{0.4cm}

{\large \textcolor{blue}{\textbf{Presented By}}}\\[0.25cm]
{\normalsize Milav Jayeshkumar Dabgar}

\vspace{0.3cm}

{\large \textcolor{blue}{\textbf{Under The Guidance of}}}\\[0.25cm]
{\normalsize Lecturer, Department of ECE}\\[0.15cm]
{\normalsize Government Polytechnic Palanpur}

\vspace{0.4cm}

{\small \textbf{DEPARTMENT OF ELECTRONICS AND COMMUNICATION ENGINEERING}}\\[0.1cm]
{\small \textbf{GOVERNMENT POLYTECHNIC PALANPUR}}
