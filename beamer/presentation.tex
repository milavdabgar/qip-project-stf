...
{\small AICTE QIP PG Certification Programme on}\\[0.15cm]
{\small \textbf{"Deep Learning: Fundamentals and Applications"}}

\vspace{0.6cm}

{\LARGE \textcolor{red}{\textbf{System Threat Forecaster}}}
...
\centering
\includegraphics[width=0.7\textwidth]{AICTE.jpeg}
...
\column{0.35\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{svnit_logo.jpg}
\end{columns}

\vspace{0.7cm}

{\large \textcolor{blue}{\textbf{Presented By}}}\\[0.3cm]
{\normalsize Milav Jayeshkumar Dabgar}

\vspace{0.5cm}

{\large \textcolor{blue}{\textbf{Under The Guidance of}}}\\[0.3cm]
